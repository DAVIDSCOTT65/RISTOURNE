...
Public Class Recu_Cotisation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RISTOURNE.Recu_Cotisation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRecu_Cotisation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Recu_Cotisation = New Recu_Cotisation()
        rpt.Site = Me.Site
        Return rpt
    End Function
